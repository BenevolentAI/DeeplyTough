...
# TOUGH-M1 dataset
mkdir TOUGH-M1
wget https://osf.io/93de7/download -O dt_tough.zip && unzip dt_tough.zip
rm dt_tough.zip
...
# Vertex dataset
mkdir Vertex
wget https://osf.io/m8q75/download -O dt_vertex.zip && unzip dt_vertex.zip
rm dt_vertex.zip
...
wget https://osf.io/7x2vs/download -O dt_prospeccts.zip && unzip dt_prospeccts.zip
